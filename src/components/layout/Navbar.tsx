          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-brand-steel/10">
            ...
            {unread > 0 && (
              <button
                ...
                className="flex items-center gap-1 text-xs text-brand-wine hover:text-brand-rose transition-colors"
              >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm font-medium truncate ${!n.is_read ? 'text-white' : 'text-brand-silver'}`}>
                        {n.title}
                      </p>
