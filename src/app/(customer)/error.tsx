...
export default function CustomerError({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center py-24">
      ...
      <h2 className="font-display text-2xl font-bold text-white mb-2">Error inesperado</h2>
      <p className="text-brand-silver text-sm max-w-sm mb-6">
        Algo salió mal en esta sección. Puedes reintentar o volver a tu dashboard.
      </p>
      <div className="flex items-center gap-3 flex-wrap justify-center">
        ...
        >
          <ArrowLeft className="h-3.5 w-3.5" /> Mi cuenta
        </Link>
      </div>
    </div>
  )
