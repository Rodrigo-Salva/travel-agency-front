...
export default function AdminError({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center py-24">
      ...
      <h2 className="font-display text-2xl font-bold text-white mb-2">Error en el panel</h2>
      <p className="text-brand-silver text-sm max-w-sm mb-6">
        Ocurrió un error en esta sección del panel de administración.
      </p>
      ...
      {error.digest && (
        <p className="mt-4 text-xs text-brand-steel/40 font-mono">ID: {error.digest}</p>
      )}
    </div>
  )
}
